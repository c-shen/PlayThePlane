...
class ViewController: UIViewController, UMSocialUIDelegate {
    ...
    @objc func shareGame() {
        ...
        UMSocialSnsService.presentSnsIconSheetView(self, appKey:"55e5338f67e58e51ae0010da", shareText: "很好玩的小游戏,小时都玩过吧!https://github.com/c-shen", shareImage: UIImage(named: "icon.png"), shareToSnsNames: [UMShareToSina,UMShareToTencent,UMShareToRenren, UMShareToDouban,], delegate: self)
    ...
    @objc func helpGame() {
        ...
        presentViewController(help, animated: true) { () -> Void in
    ...
    private func setupUI() {
        ...
        view.addConstraint(NSLayoutConstraint(item: solitaire, attribute: NSLayoutAttribute.CenterY, relatedBy: NSLayoutRelation.Equal, toItem: view, attribute: NSLayoutAttribute.CenterY, multiplier: 1.0, constant: -10))
        ...
        view.addConstraint(NSLayoutConstraint(item: help, attribute: NSLayoutAttribute.CenterX, relatedBy: NSLayoutRelation.Equal, toItem: solitaire, attribute: NSLayoutAttribute.CenterX, multiplier: 1.0, constant: 0))
        view.addConstraint(NSLayoutConstraint(item: help, attribute: NSLayoutAttribute.CenterY, relatedBy: NSLayoutRelation.Equal, toItem: solitaire, attribute: NSLayoutAttribute.CenterY, multiplier: 1.0, constant: 40))
        share.translatesAutoresizingMaskIntoConstraints = false
        view.addConstraint(NSLayoutConstraint(item: share, attribute: NSLayoutAttribute.CenterX, relatedBy: NSLayoutRelation.Equal, toItem: help, attribute: NSLayoutAttribute.CenterX, multiplier: 1.0, constant: 0))
        view.addConstraint(NSLayoutConstraint(item: share, attribute: NSLayoutAttribute.CenterY, relatedBy: NSLayoutRelation.Equal, toItem: help, attribute: NSLayoutAttribute.CenterY, multiplier: 1.0, constant: 40))
        ...
        help.addTarget(self, action: "helpGame", forControlEvents: UIControlEvents.TouchUpInside)
    ...
    private lazy var help: UIButton = UIButton(title: "游戏帮助", imageName: "btn", fontSize: 20, width: 5 , height: 5, color: UIColor.whiteColor())
